...
time_for_one_task = '0.125'
    ...
    ', всего задач: '+ number_of_complete_hw ,\
    ', затрачено часов:'+ number_of_hours_spent ,\
    ', среднее_время_выполнения: '+time_for_one_task +' часа')
...
example = 'Топинамбур'
    ...
    print(example[5:])
    print(example[::-1]
# первый и второй индекс означает начало и конец среза,третий индекс означает шаг пропуска элемента строки
